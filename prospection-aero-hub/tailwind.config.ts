  ...
  theme: {
    ...
    extend: {
      ...
      fontSize: {
        ...
        "hero-mobile": ["2.25rem", { lineHeight: "1.05", letterSpacing: "-0.03em" }],
        "section": ["2.5rem", { lineHeight: "1.1", letterSpacing: "-0.02em" }],
        "section-mobile": ["1.75rem", { lineHeight: "1.1", letterSpacing: "-0.02em" }],
        "card-title": ["1.375rem", { lineHeight: "1.2", letterSpacing: "-0.01em" }],
        "label": ["0.6875rem", { lineHeight: "1.4", letterSpacing: "0.12em" }],
        "btn": ["0.8125rem", { lineHeight: "1", letterSpacing: "0.08em" }],
      },
      colors: {
